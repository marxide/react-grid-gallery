...
class Image extends Component {
    ...
    render () {
        ...
        var customOverlay = (typeof this.props.item.customOverlay === 'undefined')
                ? <noscript/> :
                <div className={this.props.classNamePrefix+"-custom-overlay"}
        ...
        return (
                <div className={this.props.classNamePrefix+"-tile"}
            ...
            style={{
                ...
                <div className={this.props.classNamePrefix+"-tile-icon-bar"}
            ...
            style={{
                ...
                <div className={this.props.classNamePrefix+"-tile-overlay"}
            ...
            style={{
                ...
                <div className={this.props.classNamePrefix+"-tile-viewport"}
            ...
            onClick={this.props.onClick ?
                ...
                {this.props.item.thumbnailCaption && (
                        <div className={this.props.classNamePrefix+"-tile-description"}
                    style={{
                        background: "white",
                        height: "100%",
                        width: "100%",
