...
var Image = function (_Component) {
    ...
    _createClass(Image, [{
        key: 'tagContainerStyle',
        value: function tagContainerStyle() {
            if (this.props.tagContainerStyle) return this.props.tagContainerStyle;
            return {
                padding: "2px",
                pointerEvents: "none",
                position: "absolute",
        ...
        value: function render() {
            ...
            var customOverlay = typeof this.props.item.customOverlay === 'undefined' ? _react2.default.createElement('noscript', null) : _react2.default.createElement(
                'div',
                { className: this.props.classNamePrefix + "-custom-overlay",
            ...
            return _react2.default.createElement(
                'div',
                { className: this.props.classNamePrefix + "-tile",
                ...
                _react2.default.createElement(
                    'div',
                    { className: this.props.classNamePrefix + "-tile-icon-bar",
                ...
                _react2.default.createElement(
                    'div',
                    { className: this.props.classNamePrefix + "-tile-bottom-bar",
                        key: "tile-bottom-bar-" + this.props.index,
                        style: this.tagContainerStyle() },
                    tags
                ),
                customOverlay,
                _react2.default.createElement('div', { className: this.props.classNamePrefix + "-tile-overlay",
                ...
                _react2.default.createElement(
                    'div',
                    { className: this.props.classNamePrefix + "-tile-viewport",
                ...
                this.props.item.thumbnailCaption && _react2.default.createElement(
                    'div',
                    { className: this.props.classNamePrefix + "-tile-description",
                        style: {
                            background: "white",
                            height: "100%",
                            width: "100%",
...
Image.propTypes = {
    ...
    tagContainerStyle: _propTypes2.default.object,
